...
public class RestExceptionHandler {
	...
	public String constrainViolationException(ConstraintViolationException e) {
		System.out.println("ConstraintViolationException에 예외 발생");
		return e.toString();
	}

	/*
	 * @ExceptionHandler(value = MethodArgumentNotValidException.class) public
	 * List<ExceptionFieldMessage>
	 * methodArgumentNotValidException(MethodArgumentNotValidException e) {
	 * 
	 * List<ExceptionFieldMessage> errorList = new ArrayList<>();
	 * 
	 * e.getBindingResult().getAllErrors().forEach(action -> { FieldError fieldError
	 * = (FieldError)action; String fieldName = fieldError.getField(); String
	 ...
	 * 
	 * System.out.println("MethodArgumentNotValidException에 예외 발생"); return
	 * errorList; }
	 */
	...
	public ApiErrorResponse methodArgumentNotValidException(MethodArgumentNotValidException e) {
		...
		System.out.println("MethodArgumentNotValidException에 예외 발생");
